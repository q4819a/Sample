...
public class RegularExpression {
    ...
    public static boolean isIDCard(String toCheckStr) {
        // String patternStr =
        // "/^((1[1-5])|(2[1-3])|(3[0-7])|(4[1-6])|(5[0-4])|(6[0-9])|(7[12])|(8[0-9])|(9[0-9])|
        // (10[0-9])|(11[0-1])|(12[0-9])|(13[0-3])|(14[0-9]))"
        // + "\\d{4}("
        ...
        // + ")\\d{3}(\\d|X|x)?$/";
        // String patternStr1 =
        // "/^((1[1-5])|(2[1-3])|(3[0-7])|(4[1-6])|(5[0-4])|(6[0-9])|(7[0-9])|(8[0-9])|(9[0-1])|
		// (10[0-9])|(11[0-3])|(12[0-9]))"
        // + "\\d{4}("
    ...
    public static boolean isTeleNo(String toCheckStr) {
        String patternStr = "(^[0-9]{3,4}\\-[0-9]{3,8}$)|(^[0-9]{3,8}$)|(^\\([0-9]{3,4}\\)" +
    ...
    public static boolean isEmail(String toCheckStr) {
        String patternStr = "^\\w+((-\\w+)|(\\.\\w+))*\\@[A-Za-z0-9]+((\\.|-)[A-Za-z0-9]+)*\\" +
				".[A-Za-z0-9]+$";
        return canMatch(toCheckStr, patternStr);
    }
    ...
    public static boolean isWorkPhone(String toCheckStr) {
        String patternStr = "(^[0-9]{3,4}-[0-9]{7,8}-[0-9]{3,4}$)|(^[0-9]{3,4}-[0-9]{7,8}$)|" +
				"(^[0-9]{7,8}-[0-9]{3,4}$)|(^[0-9]{7,8}$)";
        return canMatch(toCheckStr, patternStr);
    }
